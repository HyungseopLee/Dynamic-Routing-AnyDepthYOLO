...
taus (decode-once), so the disk/decode cost is not paid 11x.
    ...
    python trt_bench/trt_video_eval_kitti.py \
        --base trt_bench/onnx/kitti/base.fp16.engine \
        --super trt_bench/onnx/kitti/super.fp16.engine \
        --policy method02_advantage_regress_tinyConv/outputs/kitti/policy.pt \
...
def main():
    ...
    ap.add_argument("--out", default="trt_bench/trt_video_eval_kitti.json")
    args = ap.parse_args()
