...
deployed cost of routing, not a replay.
    ...
    python trt_bench/trt_video_eval.py --base trt_bench/onnx/bdd/base.fp16.engine \
...
from method02_advantage_regress_tinyConv.feature_tap import INPUT_LEVEL_LAYERS
from method02_advantage_regress_tinyConv.eval_video_bdd import (
...
def main():
    ...
    import json
    out = Path("trt_bench/trt_video_eval_bdd.json")
