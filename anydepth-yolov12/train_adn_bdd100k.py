...
if args.resume:
    ...
    model = YOLO("./ultralytics/cfg/models/v12/yolo-ad-v12l.yaml", task=args.task)
...
python -m torch.distributed.run --nproc_per_node 2 train_adn_bdd100k.py \
  ...
  2>&1 | tee ./runs/bdd100k/detect/baseline-yolov12l/test.log
...
python -m torch.distributed.run --nproc_per_node 2 train_adn_bdd100k.py \
  ...
  2>&1 | tee ./runs/bdd100k/detect/anydepth-yolov12l/train_50e_SGD0900_bs64_nbs256_imgsz640_scale050.log
