...
Usage:
    ...
    python ./method03_advantage_rank/build_flops_table.py \
        --weight runs/kitti/detect/anydepth-yolov12s/train/weights/best.pt \
        --imgsz 384 1280 \
        --out method03_advantage_rank/outputs/kitti/flops_table.json
    ...
    python ./method03_advantage_rank/build_flops_table.py \
        ...
        --imgsz 720 1280 \
        --out method03_advantage_rank/outputs/bdd100k/flops_table.json
"""
