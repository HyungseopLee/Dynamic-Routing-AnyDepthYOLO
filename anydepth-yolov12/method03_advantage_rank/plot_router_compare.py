...
Usage:
    python method03_advantage_rank/plot_router_compare.py \
        --curves "tiny-conv:method03_advantage_rank/outputs/kitti/eval/video_curve_tinyconv_backbone_valtau.json,GAP-MLP:method01_advantage_regress/outputs/kitti/eval/video_curve_mlp_backbone_valtau.json" \
        --metric map50 --out method03_advantage_rank/outputs/kitti/eval/fig_router_compare
"""
