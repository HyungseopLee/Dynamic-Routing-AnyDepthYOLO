...
detector forward only needs to happen once here.
    ...
    conda run -n yolov12 python -m method02_advantage_regress_tinyConv.dump_perframe_kitti \
        --weight runs/kitti/detect/anydepth-yolov12s/train/weights/best.pt \
        --policy method02_advantage_regress_tinyConv/outputs/kitti/ablation/policy_input_g2_s0.pt \
...
from method02_advantage_regress_tinyConv.feature_tap import INPUT_LEVEL_LAYERS, STATE_LAYERS
from method02_advantage_regress_tinyConv.eval_video import load_policy, grid_vec
