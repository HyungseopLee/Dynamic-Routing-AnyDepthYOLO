...
Usage:
    python method02_advantage_regress_tinyConv/plot_ablation.py \
        --curve ./method02_advantage_regress_tinyConv/outputs/kitti/eval/video_curve_featabl_seeds.json \
        --out   method02_advantage_regress_tinyConv/outputs/kitti/eval/
"""
