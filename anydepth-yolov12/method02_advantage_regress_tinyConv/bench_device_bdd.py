...
blended table for the SUPER-rates that appear on the BDD Pareto curve.
    ...
    conda run -n yolov12 python -m method02_advantage_regress_tinyConv.bench_device_bdd \
        --weight finetuned_bdd100k/anydepth_best.pt \
...
def main():
    ...
    ap.add_argument("--weight", default="finetuned_bdd100k/anydepth_best.pt")
