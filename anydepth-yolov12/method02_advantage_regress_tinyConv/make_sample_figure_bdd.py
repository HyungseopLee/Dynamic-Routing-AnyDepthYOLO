...
visualization confidence.
    ...
    conda run -n yolov12 python -m method02_advantage_regress_tinyConv.make_sample_figure_bdd \
        --weight finetuned_bdd100k/<alpha0.2>.pt --scan 1500
"""
import argparse
import json
import sys
...
OUT = (Path(__file__).resolve().parent.parent.parent / "paper/_extracted")
