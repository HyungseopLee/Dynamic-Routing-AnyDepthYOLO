...
the condition of each segment.
    ...
    conda run -n yolov12 python -m method02_advantage_regress_tinyConv.make_scenario_figures_bdd
"""
import json
import pickle
...
import method02_advantage_regress_tinyConv.sim_latency_budget as S
...
FIG = Path(__file__).resolve().parent.parent.parent / "paper/_extracted/fig_scenario_budget.pdf"
