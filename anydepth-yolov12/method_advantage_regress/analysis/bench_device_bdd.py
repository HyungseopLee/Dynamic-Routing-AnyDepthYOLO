...
blended table for the SUPER-rates that appear on the BDD Pareto curve.
    ...
    python -m method_advantage_regress.analysis.bench_device_bdd \
...
def main():
    ...
    ap.add_argument("--weight", default="finetuning_AnyDepthYOLO/weights/bdd100k/anydepth_best.pt")
    ...
    from method_advantage_regress.router.feature_tap import STATE_LAYERS, INPUT_LEVEL_LAYERS
    from method_advantage_regress.train.build_cache import grids, forward_path
    cap = {}
