...
Usage:
    python -m method_advantage_regress.analysis.plot_advantage_dist
    python -m method_advantage_regress.analysis.plot_advantage_dist --dataset kitti
    python -m method_advantage_regress.analysis.plot_advantage_dist --dataset bdd100k
    python -m method_advantage_regress.analysis.plot_advantage_dist --dataset waymo
"""
import argparse
...
DATASET_DEFAULTS = {
    "kitti": dict(
        ...
        out="method_advantage_regress/outputs/figures/fig_advantage_dist_kitti.pdf",
    ),
    "bdd100k": dict(
        label="BDD100K",
        cache="method_advantage_regress/outputs/bdd100k/cache_val_both.pt",
        out="method_advantage_regress/outputs/figures/fig_advantage_dist_bdd.pdf",
    ),
    "waymo": dict(
        label="Waymo",
        cache="method_advantage_regress/outputs/waymo/cache_val_both.pt",
        out="method_advantage_regress/outputs/figures/fig_advantage_dist_waymo.pdf",
    ),
}
