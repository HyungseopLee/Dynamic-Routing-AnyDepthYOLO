...
#   bash method_advantage_regress/ablation/run_bdd_router_grid_abl.sh
...
CACHE_BOTH=$OUT/cache_train_both.pt
VAL_BOTH=$OUT/cache_val_both.pt
CACHE_G8=$OUT/cache_train_g8_both.pt
VAL_G8=$OUT/cache_val_g8_both.pt
