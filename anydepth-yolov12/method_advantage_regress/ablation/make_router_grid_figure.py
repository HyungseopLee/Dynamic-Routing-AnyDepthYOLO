...
Usage:
    ...
    python -m method_advantage_regress.ablation.make_router_grid_figure --dataset kitti \
        --out method_advantage_regress/outputs/figures/fig_abl_router_grid_kitti_ap5095.pdf
"""
...
CONFIGS = {
    "bdd100k": {
        "curves": [
            ...
            ("method_advantage_regress/outputs/bdd100k/eval/video_curve_router_grid_bdd.json",
             r"^(router_tinyconv|policy)$", "tab:green", "^", r"$G=8\times8$"),
        ],
        "anchor_json": "method_advantage_regress/outputs/bdd100k/eval/video_curve_archabl.json",
    },
    "kitti": {
        "curves": [
            ("method_advantage_regress/outputs/kitti/eval/video_curve_grid_abl_g1_g2.json",
             r"^policy_gap_s\d+$",   "tab:red",   "o", r"$G=1\times1$"),
            ("method_advantage_regress/outputs/kitti/eval/video_curve_grid_abl_g1_g2.json",
             r"^policy_bn\d+$",      "tab:blue",  "s", r"$G=2\times2$ (default)"),
            ("method_advantage_regress/outputs/kitti/eval/video_curve_grid_abl_g8.json",
             r"^policy_g8_s\d+$",    "tab:green", "^", r"$G=8\times8$"),
        ],
        "anchor_json": "method_advantage_regress/outputs/kitti/eval/video_curve_grid_abl_g1_g2.json",
    },
}
