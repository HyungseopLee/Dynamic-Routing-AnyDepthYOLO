...
(VDD_IN = total module, VDD_CPU_GPU_CV = compute); power_mW = volt_mV * curr_mA / 1000.
    ...
    python method_advantage_regress/jetson/bench_trt_jetson.py \
        --base  method_advantage_regress/jetson/onnx/kitti_pooled/base.fp16.engine \
        --super method_advantage_regress/jetson/onnx/kitti_pooled/super.fp16.engine \
        --router_engine method_advantage_regress/jetson/onnx/kitti/router.fp16.engine \
