...
def main():
    ...
    ap.add_argument("--out", default="method_advantage_regress/jetson/outputs/jetson_budget.pdf")
    ap.add_argument("--dump_out", default="method_advantage_regress/jetson/outputs/jetson_budget.json")
