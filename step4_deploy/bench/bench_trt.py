...
torch tensors kept resident -- engines are loaded ONCE, never reloaded per frame.
    ...
    python step4_deploy/bench/bench_trt.py --base results/step4_deploy/onnx/bdd/base.fp16.engine \
        --super results/step4_deploy/onnx/bdd/super.fp16.engine --iters 1000 --warmup 100
"""
import argparse
import time
