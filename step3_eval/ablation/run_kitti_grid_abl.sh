...
CACHE_G2_TRAIN=$CACHE_DIR/cache_train_g2.pt   # feat=both already built
CACHE_G2_VAL=$CACHE_DIR/cache_val_g2.pt
CACHE_G8_TRAIN=$CACHE_DIR/cache_train_g8_both.pt
CACHE_G8_VAL=$CACHE_DIR/cache_val_g8_both.pt
