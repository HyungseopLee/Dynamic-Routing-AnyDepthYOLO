...
detector forward only needs to happen once here.
    ...
    python -m step3_eval.dump_perframe_kitti \
        --weight results/step1_finetune/weights/kitti/best.pt \
        --router results/step3_eval/ablation/kitti/router_input_g2_s0.pt \
...
from router.feature_tap import INPUT_LEVEL_LAYERS, STATE_LAYERS
