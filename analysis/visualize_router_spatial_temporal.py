...
Usage:
    python -m analysis.visualize_router_spatial_temporal \
        ...
        --out    results/figures/router_spatial_temporal
"""
...
def plot_spatial_grid_map(net, cache, image_dir: Path, out: Path, topk: int = 9):
    ...
    from analysis.analyze_router_behavior import predict_advantage
...
def main():
    ...
    p.add_argument("--cache",  default="results/step2_router/cache/bdd100k/cache_val_both.pt")
    p.add_argument("--router", default="results/step2_router/weights/bdd100k/router_both_0.pt")
    p.add_argument("--images", default="/media/data/bdd100k_yolo/val/images")
    p.add_argument("--out",    default="results/figures/router_spatial_temporal")
