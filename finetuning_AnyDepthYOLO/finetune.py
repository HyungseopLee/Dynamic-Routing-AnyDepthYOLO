...
Usage (run from repo root):
    ...
    python finetuning_AnyDepthYOLO/finetune.py \
        --config ultralytics/cfg/models/v12/yolo-ad-v12s-orig.yaml \
...
Checkpoints are saved under finetuning_AnyDepthYOLO/logs/<dataset>/detect/<run_name>/.
"""
import argparse
...
ap.add_argument("--project", default="",     help="Output dir (default: finetuning_AnyDepthYOLO/logs/<dataset>/detect)")
...
project    = args.project or f"finetuning_AnyDepthYOLO/logs/{args.dataset or 'custom'}/detect"
