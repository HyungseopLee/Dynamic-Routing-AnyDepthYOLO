...
The router adds negligible overhead, well under a thousandth of a percent of the detector computation, and yields measurable on-device latency, energy, and frame-rate
improvements.
\end{abstract}
