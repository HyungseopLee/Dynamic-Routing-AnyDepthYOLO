...
class RTDETRTransformer(nn.Module):
    ...
    def forward(self, feats, depth=6, targets=None):
        ...
        # # woochul
        # assert depth <= self.num_decoder_layers, \
        #     f"decoder depth should be less than or equal to {self.num_decoder_layers}"
        # eval_idx = depth - self.num_decoder_layers - 1 
