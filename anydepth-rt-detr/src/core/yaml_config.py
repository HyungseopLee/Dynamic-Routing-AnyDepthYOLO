...
class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        ...
        print(f'YAMLConfig: {cfg_path}') # wchkang...   
    ...
    @property
    def criterion_kd(self, ):
        if self._criterion_kd is None and 'criterion_kd' in self.yaml_cfg:
            merge_config(self.yaml_cfg)
            self._criterion_kd = create(self.yaml_cfg['criterion_kd'])
        return self._criterion_kd
